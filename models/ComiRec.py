...
class ComiRec_DR(BasicModel):
    ...
    def __init__(self, item_num, user_num, hidden_size, batch_size, interest_num=4, seq_len=50, routing_times=3, relu_layer=False, hard_readout=True):
        super(ComiRec_DR, self).__init__(item_num, user_num, hidden_size, batch_size, seq_len)
...
class ComiRec_SA(BasicModel):
    def __init__(self, item_num, user_num, hidden_size, batch_size, interest_num=4, seq_len=50, add_pos=True, beta=0, args=None, device=None):
        super(ComiRec_SA, self).__init__(item_num, user_num, hidden_size, batch_size, seq_len, beta)
        self.interest_num = interest_num
